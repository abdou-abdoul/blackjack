 ...
 * VueMiseMin
 */
public class VueMiseMin extends Vue{
     ...
     */
    public VueMiseMin(int posX, int posY,int width,int height,RegleDeJeu regles,String legende){
        this.regles = regles;
    ...
    public void paintComponent(){
       this.setText(legende+regles.getMiseMin());
    }
