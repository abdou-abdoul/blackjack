 ...
 * VueCredit
 */
public class VueCredit extends Vue{
     ...
     */
    public VueCredit(int posX, int posY,int width,int height,JoueurBlackJack joueur,String legende){
        this.joueur = joueur;
    ...
    public void paintComponent(){
       this.setText(legende+joueur.getCredit());
    }
